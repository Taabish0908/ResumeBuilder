            ...
            <section>
              ...
              <div className="space-y-4">
                {data.projects.map((project, index) => (
                  <div key={index}>
                    {/* Project header with name and links side by side */}
                    <div className="flex flex-wrap items-start justify-between gap-2 mt-3">
                      <h3 className="text-md font-medium text-zinc-800 flex-shrink-0">
                        {project.name}
                      </h3>

                      {/* Links beside project name */}
                          ...
                          {project.links.map((link, i) => {
                            ...
                            return (
                              <a
                                ...
                                className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded-md border border-zinc-200 hover:shadow-sm hover:underline flex-shrink-0"
                                style={{ color: accentColor }}
                              >
                                <Icon size={14} />
                                <span className="whitespace-nowrap">
                                  {name || (isGithub ? "GitHub" : "Link")}
                                </span>
                              </a>
                            );
                          })}
