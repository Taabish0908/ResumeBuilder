  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex  gap-1 text-sm bg-pink-700 hover:bg-pink-800 active:scale-95 text-white ring-offset-1 ring-1 ring-pink-400  items-center transition-colors px-3 py-2 rounded-lg"
      >
        <Palette size={16} />
